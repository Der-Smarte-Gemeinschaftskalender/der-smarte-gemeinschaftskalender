...
const handleResize = () => {
    ...
    if (open.value) document.documentElement.classList.add('overflow-hidden');
...
<template>
        ...
        >
            <FocusLock v-if="open" :active="open" initial-focus-selector=".close-button" class="h-full">
                <div
                ...
                >
                    <Button
                        class="absolute close-button top-0 right-0 mt-5 mr-4 p-0 border-none bg-transparent outline-none w-2rem h-2rem min-h-0"
